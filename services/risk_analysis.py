...
class RiskAnalysisService:
    ...
    def analyze_risk(self, transactions, savings):
        ...
        Format as JSON with keys: risk_score, months_to_bankruptcy
        Risk Score: 1-10, where 10 is highest risk
        months_to_bankruptcy: Number of months until potential bankruptcy if spending patterns continue
        """
